...
## Environments
- Preview: https://main--itc-sunbean--aemysites.aem.page/
- Live: https://main--itc-sunbean--aemysites.aem.live/
- Block Library: https://main--itc-sunbean--aemysites.aem.page/tools/sidekick/library.html?plugin=blocks
...
1. Open the `itc-sunbean` directory in your favorite IDE and start coding :)
